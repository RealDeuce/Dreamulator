...
static constexpr PrinterProfile profiles[] = {
	...
	{ PrinterModel::EpsonFX,    "Epson FX",       DotTech::Impact9,  720, 120, 72, 240,144, 12, 9, 24,  0.27f, 0.025f, 0.72f, 2.0f, 0.0f, 1.00f, 1.00f, 1.0f, 0.075f, 0.075f },
	...
	{ PrinterModel::HpJet,      "HP JET",         DotTech::Toner,    600, 300,300, 300,300, 30,50, 30,   0.13f, 0.01f, 0.98f, 0.3f, 0.0f, 1.00f, 1.00f, 1.0f, 0.075f, 0.075f },
	{ PrinterModel::ImageWriter, "ImageWriter",   DotTech::Impact9,  720,  72, 72, 144,144,  8, 8, 16,  0.27f, 0.025f, 0.72f, 2.0f, 0.0f, 1.00f, 1.00f, 1.0f, 0.075f, 0.075f },
};
