...
def main() -> int:
    ...
    out.append("};")
    out.append("")
    out.append("uint32_t default_ljii_context_for_pitch(float pitch_cpi, int symbol_set, int class_id)")
    out.append("{")
    out.append("\tif (pitch_cpi > 14.0f) {")
    out.append("\t\tif (class_id) {")
    out.append("\t\t\tif (symbol_set == 0x0155) return 0x440ad87au;")
    out.append("\t\t\tif (symbol_set == 0x0175) return 0x440adcceu;")
    out.append("\t\t\tif (symbol_set == 0x000e) return 0x400ae122u;")
    out.append("\t\t\treturn 0x400ad4aau;")
    out.append("\t\t}")
    ...
    out.append("\t}")
    out.append("\tif (class_id) {")
    out.append("\t\tif (symbol_set == 0x0155) return 0x440a3850u;")
    out.append("\t\tif (symbol_set == 0x0175) return 0x440a3ca0u;")
    out.append("\t\tif (symbol_set == 0x000e) return 0x400a40f0u;")
    out.append("\t\treturn 0x400a3484u;")
    out.append("\t}")
    ...
    out.append("\t}")
    out.append("\treturn best ? best->context : default_ljii_context_for_pitch((float)request.pitch / 100.0f, request.symbol_set, class_id);")
    out.append("}")
    out.append("")
