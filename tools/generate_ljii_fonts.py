...
def main() -> int:
    ...
    out.append("};")
    out.append("")
    out.append("uint32_t default_ljii_context_for_pitch(float pitch_cpi, bool bold,")
    out.append("                                        bool italic)")
    out.append("{")
    out.append("\tif (pitch_cpi > 14.0f) {")
    out.append("\t\tif (bold && italic) return 0x40094f5cu;")
    out.append("\t\tif (italic) return 0x44094b08u;")
    out.append("\t\treturn bold ? 0x440946b4u : 0x400942e4u;")
    out.append("\t}")
    out.append("\tif (bold && italic) return 0x4008ac1cu;")
    out.append("\tif (italic) return 0x4408a7ccu;")
    out.append("\treturn bold ? 0x4408a37cu : 0x40089fb0u;")
    out.append("}")
    out.append("")
